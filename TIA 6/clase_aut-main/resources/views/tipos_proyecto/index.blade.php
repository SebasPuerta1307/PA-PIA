<x-app-layout>
    ...
    <div class="py-12 px-6">
        <a href="{{ route('tipos_proyecto.create') }}" class="bg-red-500 text-white px-4 py-2 rounded mb-4 inline-block">Nuevo Tipo de Proyecto</a>
                ...
                @foreach ($tipos as $tipo)
                    <tr>
                        ...
                        <td class="border px-4 py-2 space-x-2">
                            <a href="{{ route('tipos_proyecto.edit', $tipo) }}" class="text-blue-600">Editar</a>
                            <form action="{{ route('tipos_proyecto.destroy', $tipo) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
